...
// adjust servo position according to the USS read value
  ...
  else if(dist_raw == 270){
    myservo.writeMicroseconds(_DUTY_NEU);
  }
  else if(180<dist_raw<270){
    myservo.writeMicroseconds(553+102.5*((90-(270-dist_raw))/10));
  }
  else if(270<dist_raw<360){
    myservo.writeMicroseconds(1476+102.5*((180-(360-dist_raw))/10));
  }
